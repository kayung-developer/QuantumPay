...
// --- Utility Imports ---
import NProgress from './utils/nprogress'; // The slim top loading bar
...
// A wrapper component that shows the NProgress bar during lazy loading.
...
// A sub-component for cleaner admin route definitions
const AdminRoutes = () => (
    <Routes>
