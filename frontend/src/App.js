...
const InvoicingPage = lazy(() => import('./pages/dashboard/business/InvoicingPage'));
const PayrollPage = lazy(() => import('./pages/dashboard/business/PayrollPage'));
const CorporateCardsPage = lazy(() => import('./pages/dashboard/business/CorporateCardsPage')); // NEW
const CashflowPage = lazy(() => import('./pages/dashboard/business/CashflowPage')); // NEW
  ...
  return (
    ...
    <Suspense fallback={<div className="flex h-screen w-full items-center justify-center"><Spinner size="lg" /></div>}>
      <Routes>
        ...
        <Route path="/dashboard/business/invoicing" element={<ProtectedRoute><InvoicingPage /></ProtectedRoute>} />
        <Route path="/dashboard/business/payroll" element={<ProtectedRoute><PayrollPage /></ProtectedRoute>} />
