...
const SecuritySettingsPage = lazy(() => import('./pages/dashboard/settings/SecuritySettingsPage'));
const SubscriptionSettingsPage = lazy(() => import('./pages/dashboard/SubscriptionSettingsPage'));
...
const TreasuryRules = lazy(() => import('./components/business/TreasuryRules'));
...
//</Suspense><Suspense fallback={<div className="flex h-screen w-full items-center justify-center"><Spinner size="lg" /></div>}>
function App() {
  return (
  <>
    <Suspense fallback={<LazyLoader />}>
      <Routes>
        ...
        <Route path="/dashboard/settings/subscription" element={<ProtectedRoute><SubscriptionSettingsPage /></ProtectedRoute>} />
    ...
    <Route path="/business/treasury" element={<ProtectedRoute><TreasuryRules /></ProtectedRoute>} />
