        ...
        <Modal isOpen={isOpen} onClose={onClose} title={`Withdraw to ${account?.bank_name}`}>
            <div className="space-y-4">
                 ...
                 <div className="p-4 bg-neutral-800 rounded-lg">
                    <p className="text-sm text-neutral-400">Recipient</p>
                    <p className="text-base font-bold text-white mt-1">{account.account_name}</p>
                    <p className="text-sm text-neutral-300">{account.bank_name} - **** {account.account_number_mask}</p>
                 </div>
                    ...
                    >
                        {({ handleSubmit: submitForm, values, errors, touched }) => (
                            <Form>
                                ...
                                <div className="pt-6 flex justify-end items-center border-t border-neutral-800 mt-4">
                                    <Button
                                        type="button"
                                        onClick={onClose}
                                        variant="secondary"
