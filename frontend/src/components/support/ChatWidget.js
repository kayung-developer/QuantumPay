...
const ChatWidget = () => {
    ...
    return (
        <>
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 50 }} className="fixed bottom-24 right-6 z-50 w-full max-w-sm h-[60vh] bg-neutral-900/80 backdrop-blur-xl border border-neutral-700 rounded-2xl shadow-2xl flex flex-col">
