                ...
                {({ values, setFieldValue, dirty }) => (
                    <Form>
                        <div className="space-y-4">
                            <div className="flex justify-between items-center p-4 bg-neutral-50 dark:bg-neutral-50 dark:bg-neutral-800/50 rounded-lg">
                                <div>
                                    <p className="font-medium text-neutral-900 dark:text-white">Transactional Emails</p>
                                    <p className="text-xs text-neutral-600 dark:text-neutral-600 dark:text-neutral-400">Receive receipts and transfer notifications.</p>
                                </div>
                                <Switch
                             ...
                             <div className="flex justify-between items-center p-4 bg-neutral-50 dark:bg-neutral-50 dark:bg-neutral-800/50 rounded-lg">
                                <div>
                                    <p className="font-medium text-neutral-900 dark:text-white">Security Emails</p>
                                    <p className="text-xs text-neutral-600 dark:text-neutral-600 dark:text-neutral-400">Receive alerts for new device logins and password changes.</p>
                                </div>
                                <Switch
                        ...
                        {dirty && (
                            <div className="pt-4 flex justify-end border-t border-neutral-200 dark:border-neutral-800 mt-4">
