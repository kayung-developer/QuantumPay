        ...
        <Modal isOpen={isOpen} onClose={onClose} title="Setup Two-Factor Authentication">
            {!setupData && (
                <div className="text-center">
                    <p className="text-neutral-300 mb-4">Click below to start setting up 2FA with an authenticator app like Google Authenticator or Authy.</p>
            ...
            {setupData && !isVerified && (
                <div className="space-y-4">
                    <p className="text-sm text-neutral-300">1. Scan the QR code with your authenticator app.</p>
                    <div className="p-4 bg-white rounded-lg inline-block mx-auto block w-fit">
                        <QRCode value={setupData.otp_uri} size={160} />
                    </div>
                    <p className="text-sm text-neutral-300">2. Enter the 6-digit code from your app to verify the setup.</p>
            ...
            {setupData && isVerified && (
                 <div className="space-y-4 text-center">
                    ...
                    <p className="text-neutral-300">Please save these recovery codes in a secure place. They can be used to access your account if you lose your device.</p>
        ...
        <div className="space-y-6">
            ...
            >
                <div className="flex items-center justify-between">
                    <p className="text-sm text-neutral-300">Update the password you use to log in.</p>
            ...
            >
                 <div className="flex items-center justify-between">
                    <div>
                        <p className="text-sm text-neutral-300">Status:
