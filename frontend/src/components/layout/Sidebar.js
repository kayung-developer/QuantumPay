...
const Sidebar = ({ onLinkClick }) => {
  ...
  const businessNavLinks = [
        ...
        { name: t('sidebar_payment_links'), href: '/business/payment-links', icon: LinkIcon },
        ...
        { name: t('sidebar_treasury'), href: '/business/treasury', icon: SparklesIcon },
        { name: t('sidebar_batch_payouts'), href: '/business/batch-payouts', icon: BanknotesIcon },
        { name: t('sidebar_accounting_sync'), href: '/business/accounting-sync', icon: CircleStackIcon },
    ];
