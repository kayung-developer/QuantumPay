...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled || isOpen ? 'bg-neutral-900/80 backdrop-blur-md shadow-lg' : 'bg-transparent'}`}>
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                      isActive ? 'text-primary-light' : 'text-neutral-300 hover:bg-neutral-800 hover:text-white'
                    }`
                  }
                >
                  {link.name}
                    ...
                    <>
                        <motion.div variants={mobileLinkVariants} className="w-full">
                            <Link
                                to="/login"
                                onClick={() => setIsOpen(false)}
                                className="w-full text-left text-neutral-300 hover:bg-neutral-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium"
                            >
                                Login
                            </Link>
                        </motion.div>
