...
const Logo = () => (
    <Link to="/" className="flex items-center space-x-2">
        ...
        alt="QuantumPay Logo"
        className="h-8 w-8" // You can adjust the size here (e.g., h-10 w-10)
      />
...
const SocialIcon = ({ href, children }) => (
    <a href={href} target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-primary transition-colors">
        {children}
    </a>
);
                ...
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    ...
                    <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                <h3 className="text-sm font-semibold text-neutral-200 tracking-wider uppercase">Product</h3>
                                <ul className="mt-4 space-y-4">
                                    {sections.Product.map(item => (
                                        <li key={item.name}>
                                            <Link to={item.href} className="text-base text-neutral-400 hover:text-primary transition-colors">
                                                {item.name}
                                            </Link>
                                        </li>
                                    ))}
                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                <h3 className="text-sm font-semibold text-neutral-200 tracking-wider uppercase">Resources</h3>
                                <ul className="mt-4 space-y-4">
