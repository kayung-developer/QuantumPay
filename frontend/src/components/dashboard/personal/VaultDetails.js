...
const VaultDetails = ({ vault }) => {
    ...
    return (
        <motion.div
            ...
            className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-lg p-6 space-y-6"
        >
            {/* Header */}
            <div className="border-b border-neutral-200 dark:border-neutral-800 pb-4">
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <p className="text-neutral-600 dark:text-neutral-400 text-sm mt-1">{vault.description}</p>
                    </div>
            ...
            <div>
                 ...
                 <div className="mt-4 text-center text-sm text-neutral-500 p-8 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg">
            ...
            <div>
                 ...
                 <ul className="mt-4 space-y-3">
                    {vault.members.map(member => (
                        <li key={member.id} className="flex items-center justify-between p-3 bg-neutral-50 dark:bg-neutral-800/50 rounded-md">
