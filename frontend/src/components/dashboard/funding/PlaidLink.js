...
const PlaidLink = ({ onLinkSuccess }) => {
    ...
    useEffect(() => {
        const createLinkToken = async () => {
            ...
            try {
                ...
                toastError("Could not connect to our banking partner. Please try again later.");
    ...
    const onSuccess = React.useCallback(async (public_token, metadata) => {
        ...
        if (result.success) {
            toastSuccess("Bank account linked successfully!", { id: toastId });
            setIsLinked(true);
            ...
            toastError("Failed to link your bank account. Please try again.", { id: toastId });
        }
    ...
    if (isLinked) {
        return (
             <div className="p-8 text-center space-y-4">
                ...
                <p className="text-neutral-700 dark:text-neutral-300">Your bank account is now securely connected. You can now make deposits via ACH.</p>
