...
const transactionMetadata = {
  ...
  DEFAULT: { icon: BanknotesIcon, color: 'text-neutral-400', label: 'Transaction' }
};
    ...
    >
      <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-300">
        <div className="flex items-center">
          <div className={`p-1.5 rounded-full bg-neutral-800 ${color}`}>
            <Icon className="h-5 w-5" />
          </div>
          <div className="ml-4">
            <div className="font-medium text-white">{label}</div>
            <div className="text-neutral-400 text-xs">{peer || 'System Transaction'}</div>
          </div>
        </div>
      </td>
      <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-300">
...
const SkeletonRow = () => (
    <tr>
        ...
        <td className="px-6 py-4 text-right"><div className="h-5 w-16 bg-neutral-700 rounded-full inline-block animate-pulse" /></td>
    </tr>
)
        ...
        <table className="min-w-full divide-y divide-neutral-800">
          <thead className="bg-neutral-800/50">
            <tr>
              ...
              <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-neutral-400 uppercase tracking-wider">Transaction ID</th>
              ...
              <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-neutral-400 uppercase tracking-wider">Status</th>
            </tr>
          </thead>
