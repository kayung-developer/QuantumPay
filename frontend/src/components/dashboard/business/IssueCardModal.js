      ...
      >
        {({ errors, touched, values }) => (
          <Form className="space-y-6">
            ...
            />
            <div>
              <label className="block text-sm font-medium text-neutral-300 mb-2">Card Type</label>
              <div role="group" className="flex space-x-4">
                <label className="flex items-center space-x-2">
                  <Field type="radio" name="card_type" value="virtual" className="h-4 w-4 text-primary bg-neutral-800 border-neutral-700 focus:ring-primary" />
                  <span className="text-sm">Virtual</span>
                </label>
                <label className="flex items-center space-x-2">
                  <Field type="radio" name="card_type" value="physical" className="h-4 w-4 text-primary bg-neutral-800 border-neutral-700 focus:ring-primary" />
