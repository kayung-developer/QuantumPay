  ...
  <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 text-center overflow-hidden">
    <div className="container mx-auto px-4 z-10 relative">
      ...
      >
        ...
        <p className="mt-6 max-w-2xl mx-auto text-lg md:text-xl text-neutral-400">
   ...
   <section id="features" className="py-20 lg:py-32 bg-neutral-50 dark:bg-neutral-950">
    <div className="container mx-auto px-4">
      <div className="text-center">
        <h2 className="font-display text-3xl ... font-bold text-neutral-900 dark:text-neutral-900 dark:text-white">Why Choose QuantumPay?</h2>
        <p className="mt-4 ... text-lg text-neutral-600 dark:text-neutral-400">
          We've built a platform that goes beyond payments...
        </p>
      </div>
      <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
        {features.map((feature, index) => (
          <motion.div
            key={feature.title}
            // [THE FIX] Add theme-aware background and border for feature cards
          ...
          >
            ...
            <h3 className="mt-6 font-display text-xl font-semibold text-neutral-900 dark:text-neutral-900 dark:text-white">{feature.title}</h3>
            <p className="mt-2 text-neutral-400 dark:text-neutral-400">{feature.description}</p>
          </motion.div>
        ))}
      </div>
    </div>
