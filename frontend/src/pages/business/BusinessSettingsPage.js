    ...
    return (
        <DashboardLayout pageTitleKey="business_settings_title">
            <div className="max-w-5xl mx-auto">
                <div className="mb-8">
                    <h1 className="text-3xl font-bold font-display text-neutral-900 dark:text-white">Business Settings</h1>
                    <p className="mt-1 text-neutral-600 dark:text-neutral-400">Manage your business profile, legal information, and operational settings.</p>
                </div>
