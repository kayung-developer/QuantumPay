...
const CashflowPage = () => {
    ...
    return (
        <DashboardLayout pageTitleKey="cashflow_title">
            <div>
                <h1 className="text-3xl font-bold font-display text-neutral-900 dark:text-white">{t('cashflow_title')}</h1>
                <p className="mt-1 text-neutral-600 dark:text-neutral-400">{t('cashflow_header_subtitle')}</p>
            </div>
