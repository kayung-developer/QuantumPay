        ...
        <DashboardLayout pageTitleKey="team_management_title">
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold font-display text-neutral-900 dark:text-white">{t('team_management_title')}</h1>
                        <p className="mt-1 text-neutral-600 dark:text-neutral-400">{t('team_header_subtitle')}</p>
                    </div>
                    <Button onClick={() => setModalState({ isOpen: true, employee: null })}>
                        <PlusIcon className="h-5 w-5 mr-2" /> {t('team_invite_button')}
                    </Button>
                </div>
