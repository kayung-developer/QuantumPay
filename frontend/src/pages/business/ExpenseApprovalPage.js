    ...
    return (
        <DashboardLayout pageTitleKey="expense_approvals_title">
             <div className="space-y-6">
                <div>
                    <h1 className="text-3xl font-bold font-display text-neutral-900 dark:text-white">Expense Approvals</h1>
                    <p className="mt-1 text-neutral-600 dark:text-neutral-400">Review and approve expense reports from your team.</p>
                </div>
                {renderContent()}
            </div>
        </DashboardLayout>
