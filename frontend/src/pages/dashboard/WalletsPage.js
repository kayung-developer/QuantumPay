...
import { toastSuccess, toastError } from '../../components/common/Toast'; // Added for better user feedback
...
const WalletsPage = () => {
  ...
  const handleWalletAdded = (newWallet) => {
        ...
        refetchWallets();
        toastSuccess(`Your new ${newWallet.currency_code} wallet has been added!`);
    };
  ...
  const handleDepositSuccess = () => {
    handleCloseModal();
    toastSuccess(`Deposit initiated! Your ${selectedWallet?.currency_code} balance will be updated shortly.`);
