        ...
        <div className="bg-neutral-800 p-4 rounded-lg">
            <div className="flex justify-between items-center">
                ...
                <input
                    ...
                    placeholder="0.00"
                    className="bg-transparent text-2xl font-bold text-white text-right w-full focus:outline-none"
                    disabled={disabled}
                />
            </div>
...
const ExchangePage = () => {
        ...
        return (
            <DashboardLayout pageTitle="Exchange">
                 <div className="text-center">
                    <h2 className="text-xl font-semibold">Currency Exchange Not Available</h2>
                    <p className="text-neutral-400 mt-2">You need at least two different currency wallets to use the exchange.</p>
                 </div>
            </DashboardLayout>
        )
    }
    ...
    return (
        <DashboardLayout pageTitle="Currency Exchange">
            <div className="max-w-md mx-auto bg-neutral-900 border border-neutral-800 rounded-lg p-8 space-y-6">
                <CurrencyInput
                    wallets={wallets}
                ...
                <div className="relative flex justify-center items-center">
                    ...
                    <button
                        ...
                        className="relative z-10 p-2 bg-neutral-900 border-2 border-primary rounded-full text-primary hover:bg-primary hover:text-white transition-colors"
                    >
                ...
                {quote && (
                    <motion.div
                        ...
                        className="text-sm text-center text-neutral-400 pt-4 border-t border-neutral-700"
                    >
