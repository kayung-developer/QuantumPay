    ...
    return (
        <DashboardLayout pageTitle="Smart USSD">
            <div className="space-y-8">
                <div>
                    <h1 className="text-3xl font-bold font-display text-white">Smart USSD Generator</h1>
                    ...
                    >
                        ...
                        {generatedString ? (
                            <div className="space-y-4">
                                <p className="text-sm text-neutral-400">Copy the code below and paste it into your phone's dialer to complete the transaction.</p>
