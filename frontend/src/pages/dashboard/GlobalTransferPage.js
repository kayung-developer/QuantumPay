        ...
        <DashboardLayout pageTitle="Send Global">
            <div className="max-w-lg mx-auto">
                 <div className="mb-8 text-center">
                    ...
                    <h1 className="mt-4 text-3xl font-bold font-display text-white">Send Money Across Africa</h1>
                ...
                <div className="p-8 bg-neutral-900 border border-neutral-800 rounded-lg space-y-6">
                    <div>
                        <label className="block text-sm font-medium text-neutral-300 mb-1">Recipient's Email</label>
                        <input name="receiver_email" value={formState.receiver_email} onChange={handleChange} className="w-full bg-neutral-800 p-3 rounded-md text-white" />
                    </div>
                     <div>
                        <label className="block text-sm font-medium text-neutral-300 mb-1">You Send</label>
                        <div className="flex">
                            <input name="send_amount" value={formState.send_amount} onChange={handleChange} type="number" className="w-full bg-neutral-800 p-3 rounded-l-md text-white" />
                            <select name="send_currency" value={formState.send_currency} onChange={handleChange} className="bg-neutral-700 p-3 rounded-r-md text-white">
