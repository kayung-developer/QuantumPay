        ...
        <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div className="w-full md:w-1/2 lg:w-1/3">
                <input
                    ...
                    className="block w-full px-4 py-2 bg-neutral-800 border border-neutral-700 rounded-md shadow-sm text-neutral-100 placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-primary transition-colors duration-200"
                />
            </div>
