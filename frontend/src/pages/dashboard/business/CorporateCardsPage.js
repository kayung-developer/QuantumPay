...
const CorporateCardsPage = () => {
    ...
    const handleCardIssued = (newCard) => {
        ...
        toast.success(`Successfully issued a ${newCard.card_type} card to ${newCard.assigned_user.full_name}.`);
    };
        ...
        <DashboardLayout pageTitle="Corporate Cards">
            <div className="space-y-6">
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold font-display text-white">Corporate Cards</h1>
                        <p className="mt-1 text-neutral-400">Issue, manage, and control company spending in real-time.</p>
                    </div>
                               ...
                               {loading ? (
                                   ...
                                   <tr>
                                       <td colSpan="5" className="text-center py-12">
                                           ...
                                           <h3 className="mt-2 font-semibold text-white">No corporate cards issued</h3>
                                           <p className="mt-1 text-sm text-neutral-400">Get started by issuing your first card.</p>
                                       </td>
                                   </tr>
                               )}
                            </tbody>
