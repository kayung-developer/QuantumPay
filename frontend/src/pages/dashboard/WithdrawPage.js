...
const WithdrawPage = () => {
    ...
    const handleAddSuccess = () => {
        ...
        refetch();
        toastSuccess("Bank account added successfully!");
    };

    const handlePayoutSuccess = () => {
        setSelectedAccount(null);
        toastSuccess("Your withdrawal has been initiated successfully!");
    ...
    return (
        <DashboardLayout pageTitleKey="wallets_title"> {/* Add to i18n.js */}
