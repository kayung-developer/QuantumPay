                ...
                <div className="lg:col-span-1">
                    <div className="bg-neutral-900 border border-neutral-800 rounded-lg">
                        <div className="p-4 flex justify-between items-center border-b border-neutral-800">
                            <h2 className="text-lg font-semibold text-white">My Vaults</h2>
                ...
                <div className="lg:col-span-2">
                    {selectedVault ? (
                        <VaultDetails vault={selectedVault} />
                         ...
                         <div className="h-full flex flex-col justify-center items-center text-center p-8 bg-neutral-900 border-2 border-dashed border-neutral-800 rounded-lg">
                            <UsersIcon className="h-12 w-12 text-neutral-600"/>
                            <h3 className="mt-2 font-semibold text-white">Select a vault</h3>
                            <p className="mt-1 text-sm text-neutral-400">Choose a vault from the list to view its details, or create a new one.</p>
                        </div>
                    )}
                </div>
            </div>
