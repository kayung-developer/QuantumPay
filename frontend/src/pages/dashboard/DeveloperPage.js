...
const DeveloperPage = () => {
    ...
    const handleRevoke = async () => {
        ...
        if (result.success) {
            toast.success(`API Key "${keyToRevoke.label}" has been revoked.`);
            setKeyToRevoke(null);
            refetchKeys();
        } else {
